                ...
                <div class="col-md">
                    <form action="/events" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="date" class="form-control" name="event[date]" value="{{ old('event.date') }}">
                            <p class="date__error" style="color:red">{{ $errors->first('event.date') }}</p>
                        </div>
                        <div class="form-group mb-4">
                            <label for="beginning_time" class="col-form-label">開始時間</label>
                            <input type="time" class="form-control" name="event[beginning_time]" value="{{ old('event.beginning_time') }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="time" class="form-control" name="event[ending_time]" value="{{ old('event.ending_time') }}">
