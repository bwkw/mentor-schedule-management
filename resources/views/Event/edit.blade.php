                    ...
                    <div class="col-md">
                        <form action="/events/{{ $event->id }}" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="date" class="form-control" name="event[date]" id="date" value="{{ $event->date }}">
                            </div>
                            <div class="form-group mb-4">
                                <label for="beginning_time" class="col-form-label">開始時間</label>
                                <input type="time" class="form-control" name="event[beginning_time]" id="beginning_time" value="{{ $event->beginning_time }}">
                            </div>
                            <div class="form-group mb-4">
                                <label for="ending_time" class="col-form-label">終了時間</label>
                                <input type="time" class="form-control" name="event[ending_time]" id="ending_time" value="{{ $event->ending_time }}">
                            </div>
