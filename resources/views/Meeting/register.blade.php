...
@section('script')
    ...
    <script src="{{ mix('js/chosen-select.js') }}"></script>
@endsection
                ...
                <div class="col-md">
                    <form action="/meetings" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="date" class="form-control" name="meeting[date]" value="{{ old('meeting.date') }}">
                            <p class="date__error" style="color:red">{{ $errors->first('meeting.date') }}</p>
                        </div>
                        <div class="form-group mb-4">
                            <label for="beginning_time" class="col-form-label">開始時間</label>
                            <input type="time" class="form-control" name="meeting[beginning_time]" value="{{ old('meeting.beginning_time') }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="time" class="form-control" name="meeting[ending_time]" value="{{ old('meeting.ending_time') }}">
